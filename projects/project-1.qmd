...
This project involved using Claude Code to write the code to needed to deveop an app that provided a fun but challenging take on the classic flappy bird game.
...
- provide a simple way do experiment with AI generated code and refine its use cases and function. 
